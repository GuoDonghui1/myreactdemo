...
function NotificationBox(props) {
    return (
        <div className="app-utility-item app-notifications-dropdown dropdown">
            <a className="dropdown-toggle no-toggle-arrow" id="notifications-dropdown-toggle" data-bs-toggle="dropdown"
               href="#" role="button" aria-expanded="false" title="Notifications">
                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-bell icon"
                     fill="currentColor"
                     xmlns="http://www.w3.org/2000/svg">
                    ...
                    {props.items.map(item => (
                        <div className="item p-3" key={item.id}>
                            <div className="row gx-2 justify-content-between align-items-center">
                                <div className="col-auto">{ getImage(item.type, item.image) }
                                </div>
                                <div className="col">
                                    <div className="info">
